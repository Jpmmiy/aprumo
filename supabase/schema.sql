...
create table if not exists public.sessoes (
  id uuid primary key default gen_random_uuid(),
  user_id uuid not null references auth.users on delete cascade,
  -- Anulável de propósito: sessão sem matéria é o bloco corrido do cursinho,
  -- que conta no tempo total mas não entra nos gráficos por matéria.
  materia_id uuid references public.materias on delete cascade,
...
-- ============================================================================
-- Migração: quem rodou a primeira versão deste arquivo criou sessoes.materia_id
-- como NOT NULL. Isto solta a coluna sem perder nenhuma linha.
-- ============================================================================
alter table public.sessoes alter column materia_id drop not null;
